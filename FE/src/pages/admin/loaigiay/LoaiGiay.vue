  ...
  <div class="page-container">
    <div class="breadcrumb-section">
      <BreadcrumbDefault
        ...
        :routes="[
          { path: '/admin/loai-giay', name: 'Quản lý danh mục' }
        ]"
      />
    </div>
    ...
    <p class="section-title">
      <UnorderedListOutlined /> Danh sách danh mục
    </p>
    <ProductTable
...
import ProductFilter from './LoaiGiayFilter.vue';
import ProductTable from './LoaiGiayTable.vue';
import ProductModal from './LoaiGiayModal.vue';
import { computed, onMounted, reactive, watch } from 'vue';
import { GetSizes, type SizeResponse, type ParamsGetSize } from '@/services/api/admin/loaigiay.api';
