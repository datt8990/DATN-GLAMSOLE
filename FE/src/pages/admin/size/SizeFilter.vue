  ...
  <DivCustom>
    <div class="filter-container">
      ...
      <div class="filter-item search-input-group">
        ...
        <a-select class="select-input" v-model:value="localSearchStatus" allow-clear style="width: 180px"
...
// This 'options' array is not used in the template provided, but keeping it for context
const options = [
...
const resetFilters = () => {
  ...
  localSearchStatus.value = null // This assumes searchStatus is used somewhere else in the filter
  emit('update:searchQuery', '')
  emit('update:searchStatus', null) // Emit null for reset
}
</script>
