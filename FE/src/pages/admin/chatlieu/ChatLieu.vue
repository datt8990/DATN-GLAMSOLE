<template>
  <div class="page-container">
    ...
    <p class="section-title">
      <UnorderedListOutlined /> Danh sách chất liệu
    </p>
...
import ProductFilter from './ChatLieuFilter.vue';
import ProductTable from './ChatLieuTable.vue';
import ProductModal from './ChatLieuModal.vue';
import { computed, onMounted, reactive, watch } from 'vue';
import { GetSizes, type SizeResponse, type ParamsGetSize } from '@/services/api/admin/chatlieu.api';
