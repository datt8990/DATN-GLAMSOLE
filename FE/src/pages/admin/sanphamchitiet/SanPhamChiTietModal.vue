        ...
        <a-row :gutter="12">
          ...
          <a-col :span="6">
            <a-form-item label="Giá bán" name="facilityId" :label-col="{ span: 24 }">
              <div class="input-with-button">
                <a-input placeholder="Nhập giá bán" v-model:value="product.giaBan" />
              </div>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="12">
          ...
          <a-col :span="6">
            <a-form-item label="Số lượng" name="facilityId" :label-col="{ span: 24 }">
              <div class="input-with-button">
                <a-input placeholder="Nhập số lượng" v-model:value="product.soLuong" />
              </div>
            </a-form-item>
          </a-col>
          <a-col :span="6"></a-col>
...
const handleSubmit = async () => {
  try {
    ...
    formData.append('giaBan', product.value.giaBan?.trim() || '');
