<template>
  <DivCustom>
    ...
    <FormCreateSanPham 
    :responseCL="state.ChatLieu"
    :responseLD="state.LoaiDe"
    :responseLG="state.LoaiGiay"
    :responseXX="state.XuatXu"
    :products ="state.products"
    @addCL="openAddModalCL" 
    @addXX="openAddModalXX" 
    @addLD="openAddModalLD" 
    @addLG="openAddModalLG"
    @addColor="openAddModalColor" 
    @addSize="openAddModalSize"  
    />
    <LoaiGiayModal
    :open="state.isModalLGOpen" 
    :productId="state.selectedProductId" 
    @close="closeModalLG"
    @success="fetchProducts"
    />
    <XuatXuModal
    :open="state.isModalXXOpen" 
    :productId="state.selectedProductId" 
    @close="closeModalCXX"
    @success="fetchProducts"
    />
    <ChatLieuModal
    :open="state.isModalCLOpen" 
    :productId="state.selectedProductId" 
    @close="closeModalCL"
    @success="fetchProducts"
    />
    <LoaiDeModal
    :open="state.isModalLDOpen" 
    :productId="state.selectedProductId" 
    @close="closeModalLD"
    @success="fetchProducts"
    />
    <SizeModal
    :open="state.isModalSizeOpen" 
    :productId="state.selectedProductId" 
    @close="closeModalSize"
    @success="fetchProducts"
    />
    <MauSacModal
    :open="state.isModalColorOpen" 
    :productId="state.selectedProductId" 
    @close="closeModalColor"
    @success="fetchProducts"
    />
    <!-- <TableCreateSanPham /> -->
...
import { GetListChatLieu, GetListLoaiDe, GetListLoaiGiay, GetListXuatXu, getSanPham, type ParamsGetSanPham, type SanPhamResponse, type ThuocTinhResponse } from '@/services/api/admin/sanphamchitiet.api';
