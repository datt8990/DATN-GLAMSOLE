...
public class ThongKeDoanhThuService {
    ...
    public ThongKeDoanhThuResponse getThongKeDoanhThu() {
        ...
        // Convert sang timestamp (Long) - milliseconds
        Long startOfMonthTimestamp = startOfMonth.toEpochSecond(ZoneOffset.UTC) * 1000;
        Long endOfMonthTimestamp = endOfMonth.toEpochSecond(ZoneOffset.UTC) * 1000;
        Long startOfDayTimestamp = startOfDay.toEpochSecond(ZoneOffset.UTC) * 1000;
        Long endOfDayTimestamp = endOfDay.toEpochSecond(ZoneOffset.UTC) * 1000;
